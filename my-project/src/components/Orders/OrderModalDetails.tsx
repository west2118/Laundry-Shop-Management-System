    ...
    <Modal
      ...
      <div className="flex items-start justify-between mb-6">
        ...
        <div className="flex items-center space-x-2">
          <span className="inline-flex items-center px-3 py-1 rounded-full bg-green-100 text-green-800 text-sm font-medium capitalize">
            {selectedOrder?.orderStatus}
          </span>
          <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium capitalize ${
            selectedOrder?.paymentStatus === 'paid' ? 'bg-blue-100 text-blue-800' : 'bg-orange-100 text-orange-800'
          }`}>
